...
public class Level_9 extends Variables{
    MediaPlayer mp,mpp;

    public Level_9(Button b, Context context) {
        ...
        p2 = 700;
        c2 = obj.random_nr(600,1000);
        c3 = obj.random_nr(600,1000);
        c4 = obj.random_nr(600,1000);
        ...
        but.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    else if((obj.get_k()%5==1 && color_nr[1]==0)||(obj.get_k()%5==3 && color_nr[3]==0))
                        complete++;
    ...
    private class Operation extends AsyncTask<String, Void, String> {
        ...
        protected void onProgressUpdate(Void... values) {
            ...
            switch (progress) {
                case 0:
                    if(obj.dialog_message(complete,should,4,sw,GameActivity.class,9)) {sw=5;break;}
                    but.setBackgroundResource(obj.set_color(color_nr, true,touched,0));
                    color_nr[obj.get_k()%5]--;
                    progress=1;

                    if((obj.get_k()%5==1 && color_nr[1]==0)||(obj.get_k()%5==3 && color_nr[3]==0))
                        should++;
                    else if(obj.get_k()%5==2 && color_nr[2]==1)
                        should+=2;

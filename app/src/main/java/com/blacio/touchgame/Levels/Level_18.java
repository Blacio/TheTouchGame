...
public class Level_18 extends Variables{
    MediaPlayer mp,mpp;

    public Level_18(Button b, Context context) {
        ...
        p2 = 100;
        p3 = 900;
        p4 = obj.random_nr(1000,1600);

        c1 = obj.random_nr(700,1200);
        c2 = obj.random_nr(600,1400);
        c3 = obj.random_nr(500,1800);
        c4 = obj.random_nr(1000,1600);

        color_nr = new int[]{2,1,2,0};
    ...
    private class Operation extends AsyncTask<String, Void, String> {
        ...
        protected void onProgressUpdate(Void... values) {
            ...
            switch (progress) {
                case 0:
                    if(obj.dialog_message(complete,should,4,sw,GameActivity.class,18)) {sw=5;break;}
                ...
                case 7:
                    ...
                    if(obj.get_k()%5==1 && aux1==1) aux1=0;
